...
class Connection extends BaseConnection
{
     ...
     public function connect(bool $persistent = false)
     {
          ...
          try {
               ...
               // Defensive: ensure username/password are valid strings before using in str_replace
               if (is_scalar($this->username) && $this->username !== '') {
                    $msg = str_replace((string) $this->username, '****', $msg);
               }
               if (is_scalar($this->password) && $this->password !== '') {
                    $msg = str_replace((string) $this->password, '****', $msg);
               }
