...
--
-- Host: localhost:3306
-- Generation Time: Feb 28, 2026 at 01:18 PM
...
CREATE TABLE IF NOT EXISTS `bi_centres` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bmcm` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bm_tasks` (
  ...
  PRIMARY KEY (`mid`),
  UNIQUE KEY `unique_branch_taskDate` (`branch`,`taskDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `bm_tasks_logs` (
  `mid` int NOT NULL AUTO_INCREMENT,
  `mt0100` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mt0101` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mt0102` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `bm_weekly_list` (
  `bmw_id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `branchesmapped` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `branch_category` (
  `id` int NOT NULL AUTO_INCREMENT,
  `branch_type` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'A',
  PRIMARY KEY (`id`),
  UNIQUE KEY `branch_type` (`branch_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `branch_info` (
  `id` int NOT NULL AUTO_INCREMENT,
  `branch_id` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `processing_center_id` varchar(155) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `sbu` int NOT NULL,
  `state` int NOT NULL,
  `city` int NOT NULL,
  `category` int NOT NULL,
  `address` text COLLATE utf8mb4_general_ci NOT NULL,
  `map` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `branch_email` varchar(155) COLLATE utf8mb4_general_ci NOT NULL,
  `branch_manager_email` varchar(155) COLLATE utf8mb4_general_ci NOT NULL,
  `branch_timing_weekdays_from` time NOT NULL,
  `branch_timing_weekdays_to` time NOT NULL,
  `branch_timing_weekend_from` time NOT NULL,
  `branch_timing_weekend_to` time NOT NULL,
  `landline_no` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `mobile_no` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `pre_number` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `branch_manager_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `branch_manager_mobile` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `cluster_manager_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `cluster_manager_mobile` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `zonal_manager_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `zonal_manager_mobile` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `modified_by` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `modified_date` datetime NOT NULL,
  `last_modified_date` datetime DEFAULT NULL,
  `cluster_bmid` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `zonal_bmid` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `branding_actions` (
...
CREATE TABLE IF NOT EXISTS `branding_checklists` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `branding_checklist_items` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `checklist_id` int UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `branding_checklist_records` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `branding_photos` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `checklist_id` int UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `branding_sections` (
...
CREATE TABLE IF NOT EXISTS `branding_sub_sections` (
...
CREATE TABLE IF NOT EXISTS `cardiologist_ecg` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cardiologist_tmt` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nid` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `doctor_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `doctor_count` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cluster_branch_map` (
...
CREATE TABLE IF NOT EXISTS `cluster_zone_map` (
...
CREATE TABLE IF NOT EXISTS `clust_area_map` (
  `cl_ar_id` int NOT NULL AUTO_INCREMENT,
  `cluster_id` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `area_id` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_by` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `createdDTM` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`cl_ar_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `cm_morning_tasks` (
  `mid` int NOT NULL AUTO_INCREMENT,
  `mt0100` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mt0101` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mt0102` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `cm_night_tasks` (
  `cm_nid` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `empareamap` (
...
DROP TABLE IF EXISTS `files_orphans`;
CREATE TABLE IF NOT EXISTS `files_orphans` (
  `file_id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `form_inputs` (
  ...
  `input_label` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `input_icon` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `input_icon_color` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `input_col` varchar(10) COLLATE utf8mb4_general_ci DEFAULT 'col-md-3',
  `input_type` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `input_value` text COLLATE utf8mb4_general_ci,
  `data_source` text COLLATE utf8mb4_general_ci,
  `map_fields` text COLLATE utf8mb4_general_ci,
  `input_placeholder` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `show_when_field` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `show_when_value` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `show_operator` enum('=','!=','>','<') COLLATE utf8mb4_general_ci DEFAULT '=',
  `input_class` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `input_required` tinyint(1) DEFAULT '0',
  `input_readonly` tinyint(1) DEFAULT '0',
  `input_disabled` tinyint(1) DEFAULT '0',
  `input_min` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `input_max` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `input_step` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `input_pattern` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `input_maxlength` int DEFAULT NULL,
  `input_options` text COLLATE utf8mb4_general_ci,
  `input_order` int DEFAULT '0',
  `form_id` int NOT NULL,
  `section_id` int DEFAULT NULL,
  `sub_section_id` int DEFAULT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'A',
  `file_accept` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `max_file_size` int DEFAULT '2048',
  `compress_image` tinyint(1) NOT NULL DEFAULT '1',
  `required_when_field` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `required_when_value` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remarks_required_when` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Missing',
  `photo_required_when` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `custom_value` text COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `form_records` (
  `id` int NOT NULL AUTO_INCREMENT,
  `submission_id` int DEFAULT NULL,
  `submission_uuid` char(36) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `section_id` int NOT NULL,
  `sub_section_id` int DEFAULT NULL,
  `input_id` int NOT NULL,
  `input_value` text COLLATE utf8mb4_general_ci NOT NULL,
  `dept_id` int NOT NULL,
  ...
  `form_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_form_records_submission_uuid` (`submission_uuid`),
  KEY `idx_form_records_form_dept` (`form_id`,`dept_id`),
  KEY `idx_form_records_submission_id` (`submission_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `form_sections` (
  `section_id` int NOT NULL AUTO_INCREMENT,
  `section_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `section_icon` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dept_id` int NOT NULL,
  `form_id` int NOT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'A',
  PRIMARY KEY (`section_id`)
...
CREATE TABLE IF NOT EXISTS `form_submissions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `submission_uuid` char(36) COLLATE utf8mb4_general_ci NOT NULL,
  `form_id` int NOT NULL,
  `dept_id` int NOT NULL,
  ...
  `updated_by` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_form_submissions_form_dept` (`form_id`,`dept_id`),
  KEY `idx_form_submissions_created_dtm` (`created_dtm`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS `form_sub_sections`;
CREATE TABLE IF NOT EXISTS `form_sub_sections` (
  `sub_section_id` int NOT NULL AUTO_INCREMENT,
  `section_id` int NOT NULL,
  `form_id` int NOT NULL,
  `sub_section_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `sub_section_icon` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'A',
...
CREATE TABLE IF NOT EXISTS `hk_branchwise_budget` (
  `id` int NOT NULL AUTO_INCREMENT,
  `branch_id` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hk_branch_ideal_qty` (
  `id` int NOT NULL AUTO_INCREMENT,
  `branch_id` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hk_consumptions` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_branch_item_cycle` (`branch_id`,`hk_item_id`,`cycle_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `hk_details` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hkr_id` int NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_hk_details_hkr` (`hkr_id`),
  KEY `idx_hk_details_hk_item_id` (`hk_item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `hk_items` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_hk_items_name` (`name`),
  KEY `idx_hk_items_item_type` (`item_type`)
...
CREATE TABLE IF NOT EXISTS `hk_materials_remove` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hk_material_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `hk_monthly_indents` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_branch_month` (`branch_id`,`month`),
...
CREATE TABLE IF NOT EXISTS `hk_opening_stock` (
  `id` int NOT NULL AUTO_INCREMENT,
  `branch_id` int NOT NULL,
  `hk_item_id` int NOT NULL,
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_hk_opening_branch_item` (`branch_id`,`hk_item_id`),
  KEY `idx_opening_branch` (`branch_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `hk_requirements` (
  `hkr_id` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`hkr_id`),
  UNIQUE KEY `uniq_branch_month` (`branch_id`,`for_month`),
  KEY `idx_req_branch_month_status` (`branch_id`,`for_month`,`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `hk_requirement_receipts` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hkr_id` int NOT NULL,
  `hk_item_id` int NOT NULL,
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ux_hkr_item` (`hkr_id`,`hk_item_id`),
  KEY `idx_hkr` (`hkr_id`),
  KEY `idx_item` (`hk_item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `hk_stock_balances` (
  `id` int NOT NULL AUTO_INCREMENT,
  `branch_id` int NOT NULL,
  `hk_item_id` int NOT NULL,
  `opening_qty` decimal(12,2) DEFAULT '0.00',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_balance_branch_item` (`branch_id`,`hk_item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `hk_stock_received` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hkr_id` int DEFAULT NULL,
  `branch_id` int NOT NULL,
  `hk_item_id` int NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_received_branch` (`branch_id`,`hk_item_id`),
  KEY `idx_received_hkr` (`hkr_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `hk_visits` (
  `id` int NOT NULL AUTO_INCREMENT,
  `branch_id` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `morningtasks` (
  `mid` int NOT NULL AUTO_INCREMENT,
  `mt0100` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mt0101` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mt0102` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `new_department` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `new_emp_master` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `nighttasks` (
...
CREATE TABLE IF NOT EXISTS `power_consumption_logs` (
  `id` int NOT NULL AUTO_INCREMENT,
  `branch_id` int NOT NULL,
  `cluster_id` int DEFAULT NULL,
  `zone_id` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `regd_remarks` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `repeat_punctures` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `repeat_samples` (
  `id` int NOT NULL AUTO_INCREMENT,
  `report_type` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `regd_number` varchar(11) COLLATE utf8mb4_general_ci NOT NULL,
  `regd_remarks` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `repeat_scan` (
  `id` int NOT NULL AUTO_INCREMENT,
  `report_type` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `regd_number` varchar(11) COLLATE utf8mb4_general_ci NOT NULL,
  `regd_remarks` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sample_rejections` (
  `id` int NOT NULL AUTO_INCREMENT,
  `report_type` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `regd_number` varchar(11) COLLATE utf8mb4_general_ci NOT NULL,
  `regd_remarks` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
...
DROP TABLE IF EXISTS `vdc_forms`;
CREATE TABLE IF NOT EXISTS `vdc_forms` (
  `id` int NOT NULL AUTO_INCREMENT,
  `form_name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `form_description` text COLLATE utf8mb4_general_ci,
  `created_dtm` datetime NOT NULL,
  `created_by` int NOT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'A',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `watsapp_msg_user` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `watsapp_msg_user_list` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Constraints for table `form_records`
--
ALTER TABLE `form_records`
  ADD CONSTRAINT `fk_form_records_submission` FOREIGN KEY (`submission_id`) REFERENCES `form_submissions` (`id`) ON DELETE CASCADE;
