...
class DieselConsumption extends BaseController
{
    ...
    public function getDieselConsumptionAdminList()
    {
        ...
        $selectedCluster = $this->request->getPost('cluster_id') ?? ($jsonData['cluster_id'] ?? $this->request->getVar('cluster_id'));
        $selectedBranch = $this->request->getPost('branch_id') ?? ($jsonData['branch_id'] ?? $this->request->getVar('branch_id'));
        $selectedMonth = $this->request->getPost('month') ?? ($jsonData['month'] ?? $this->request->getVar('month'));
    ...
    public function editDieselConsumption($id = null)
    {
        ...
        $consumption_date = $this->request->getPost('consumption_date');
        ...
        $data = [
            'branch_id' => $branch_id,
            'consumption_date' => $consumption_date,
            'power_shutdown' => $this->request->getPost('power_shutdown') ?? null,
            'diesel_consumed' => $this->request->getPost('diesel_consumed') ?? null,
            'avg_consumption' => $this->request->getPost('avg_consumption') ?? null,
            'closing_stock' => $this->request->getPost('closing_stock') ?? null,
            'createdBy' => $emp_code,
            'createdDTM' => date('Y-m-d H:i:s')
        ];
