...
$routes->group("api", ['filter' => 'cors:api'], function ($routes) {
    ...
    $routes->match(['GET', 'options'], "getServicesList", "ServicesMaster::getServicesList", ['filter' => 'authFilter']);    
    $routes->match(['GET', 'options'], "getUsersServicesList", "ServicesMaster::getUsersServicesList", ['filter' => 'authFilter']);
