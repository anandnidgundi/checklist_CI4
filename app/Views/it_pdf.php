...
<html lang="en">
     ...
     $createdDtmRaw = $it['created_dtm'] ?? $it['createdDTM'] ?? $it['created_at'] ?? '';
     ...
     ?>
          ...
          <div class="pdf-wrapper">
                    ...
                    <table>
                         <tr>
                              ...
                              <td style="border:none; padding:0;  ">
                                   ...
                                   <div class="title">IT Checklist</div>
               ...
               <div class="summary-card">
                    <?php
               $auditedBy = trim((string) ($it['audited_by'] ?? ''));
               $auditedByMobile = trim((string) ($it['audited_by_mobile'] ?? $it['audited_by_phone'] ?? $it['audited_by_contact'] ?? ''));
               $visitedBy = $auditedBy;
               if ($auditedByMobile !== '') {
