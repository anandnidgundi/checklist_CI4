...
<html lang="en">
     ...
     $createdDtmRaw = $maintenance['created_dtm'] ?? $maintenance['createdDTM'] ?? $maintenance['created_at'] ?? '';
     ...
     ?>
          ...
          <div class="pdf-wrapper">
               ...
               <div class="summary-card">
                    <?php
               $auditedBy = trim((string) ($maintenance['audited_by'] ?? ''));
               $auditedByMobile = trim((string) ($maintenance['audited_by_mobile'] ?? $maintenance['audited_by_phone'] ?? $maintenance['audited_by_contact'] ?? ''));
               $visitedBy = $auditedBy;
               if ($auditedByMobile !== '') {
               ...
               $summaryData = [
                    ...
                    'Date of Visit' => $formatDate($maintenance['date_of_visit'] ?? ''),
                    ...
                    'Contact' => $maintenance['mobile_no'] ?? $maintenance['contact'] ?? '',
          ...
          ?>
               <div class="attachment-grid">
                    ...
                    <div class="attachment-card">
                         ...
                         <div class="attachment-meta">Photo uploaded on <?= esc($createdDtmDisplay) ?></div>
                         <?php endif; ?>
                    </div>
                    <?php
                    $attachmentCount++;
